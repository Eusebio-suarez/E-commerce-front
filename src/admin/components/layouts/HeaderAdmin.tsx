  ...
  return (
    <header className="bg-[#fefefe] py-6 px-8 w-full shadow-md flex justify-between">
      ...
      <div className="flex gap-6 items-center">
        ...
        <button className="bg-[#3b67e9] text-white font-medium hover:bg-[#3152df] active:scale-[103%] transition-all duration-200 py-2 px-4 rounded-md flex items-center gap-1">
