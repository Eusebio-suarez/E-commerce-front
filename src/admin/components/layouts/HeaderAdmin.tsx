  ...
  return (
    <header className="bg-[#fefefe] py-6 px-8 w-full shadow-md flex justify-between">
      <div className="flex gap-1 items-center">
        <p className="text-2xl font-medium text-neutral-900">Panel de Administración</p>
      </div>
      <div className="flex gap-6 items-center">
        ...
        <button className="bg-[#3b67e9] text-white font-medium hover:bg-[#3152df] active:scale-105 transition-all duration-200 py-2 px-4 rounded-md flex items-center gap-1">
