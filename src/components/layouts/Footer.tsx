...
export const Footer = () => {
    return (
        <div className="bg-[#fff27a] w-full h-auto relative z-20 py-3">
            <div className="flex gap-10 pt-3 justify-center pb-3.5 text-[18px] mx-auto border-b-2 w-[90%] border-[#f0cf2c] z-50 md:items-start lg:justify-evenly">
                
                <div className="flex flex-col gap-4 lg:gap-44 lg:flex-row md:flex-row md:gap-10">
                    <div className="flex flex-col">
                        <h4 className="font-bold text-[17px] lg:text-[22px]">Inesita</h4>
                        <p className="text-[11px] md:text-[15px] lg:text-[18px]">Tu destino culinario favorito</p>
                    </div>
                    <div className="flex flex-col">      
                        <h4 className="font-bold mb-1  text-[16px] md:text-[18px] lg:text-[22px]">Enlaces Rápidos</h4>
                        <div className="grid grid-cols-2 md:grid-cols-1">
                            <NavLink className="hover:text-[#df5454] text-[11px] md:text-[15px] lg:text-[18px]" to="/">Inicio</NavLink>
                            <NavLink className="hover:text-[#df5454] text-[11px] md:text-[15px] lg:text-[18px]" to="/Libros">Libros</NavLink>
                            <NavLink className="hover:text-[#df5454] text-[11px] md:text-[15px] lg:text-[18px]" to="/Recetas">Recetas</NavLink>
                            <NavLink className="hover:text-[#df5454] text-[11px] md:text-[15px] lg:text-[18px]" to="/Carrito">Carrito</NavLink>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4 lg:gap-44 lg:flex-row md:flex-row md:gap-10">
                    <div>
                        <h4 className="font-bold text-[15px] md:text-[18px] lg:text-[22px]">Contacto</h4>
                        <p className="text-[11px] md:text-[16px] lg:text-[18px]">+57 300 000 000</p>
                    </div>
                    <div className="flex flex-col">
                        <h4 className="font-bold text-[16px] md:text-[18px] lg:text-[22px]">Síguenos</h4>
            ...
            <div className="flex justify-center pt-4 text-[12px] md:text-[14px] font-semibold lg:text-[18px]">
