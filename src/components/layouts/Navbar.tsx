...
export const Navbar = () => {
    return (
        <div className="flex justify-end px-6 py-6 max-[800px]:flex max-[800px]:justify-center">
            ...
            <ul className="gap-12 flex justify-center items-center text-start">
                ...
                <li className="hover:scale-116 transition duration-200 text flex content-center items-center flex-col">
                ...
                <li className="hover:scale-116 transition duration-200 flex content-center items-center flex-col">
