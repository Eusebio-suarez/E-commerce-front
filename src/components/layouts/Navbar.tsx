        ...
        <div className="flex justify-end px-6 py-6">
            ...
            <ul className="gap-12 flex justify-center items-center text-start">
                ...
                <li className="hover:scale-116 transition duration-200 text flex flex-col items-center">
                    <NavLink to="/" className={({ isActive }) =>`gap-2 transition duration-200 ${isActive ? "text-white bg-[#df5454] px-2 py-2 w-[42px] rounded-xl font-semibold" : "text-[#000000]"}`}>
                ...
                <li className="hover:scale-116 transition duration-200 flex flex-col items-center">
                    <NavLink to="/Libros" className={({ isActive }) =>`gap-2 transition duration-200 ${isActive ? "text-white bg-[#df5454] px-2 py-2 w-[42px] rounded-xl font-semibold" : "text-[#000000]"}`}>
                ...
                <li className="hover:scale-116 transition duration-200 flex flex-col items-center">
                    <NavLink to="Recetas" className={({ isActive }) =>`gap-2 transition duration-200 ${isActive ? "text-white bg-[#df5454] px-2 py-2 w-[42px] rounded-xl font-semibold" : "text-[#000000]"}`}>
                ...
                <li className="hover:scale-116 transition duration-200 flex flex-col items-center">
                    <NavLink to="Carrito" className={({ isActive }) =>` gap-2 transition duration-200 ${isActive ? "text-white bg-[#df5454] px-2 py-2 w-[42px] rounded-xl font-semibold" : "text-[#000000]"}`}>
                ...
                <li className="hover:scale-116 transition duration-200 flex flex-col items-center">
                    <NavLink to="InicioSesion" className={({ isActive }) =>`items-center gap-2 transition duration-200 ${isActive ? "text-white bg-[#df5454] px-2 py-2 w-[42px] rounded-xl font-semibold" : "text-[#000000]"}`}>
