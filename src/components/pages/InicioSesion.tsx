    ...
    return (
        ...
        <div className="pt-16 flex justify-center items-center md:pt-20 lg:pt-28">
            ...
            <div className= "absolute w-[270px] h-[330px] flex flex-col justify-center align-middle backdrop-blur-sm  rounded-2xl shadow-2xl shadow-black md:w-[310px] md:h-[350px]  lg:w-[390px] lg:h-[440px]">
                <h3 className="text-[28px] text-center font-bold text-white lg:text-[33px]">Iniciar Sesión</h3>
                <form onSubmit={handlerLogin} className="flex flex-col justify-center items-center ">
                    
                    <input onChange={(e)=> setFormInput({...FormInput, email: e.target.value})} value={FormInput.email} type="email" className="bg-gray-300 w-[210px] h-[27px] mt-5 pl-2 rounded-[5px] outline-none md:w-[240px] md:h-[30px] lg:mt-8 lg:w-[260px] lg:h-[30px]" placeholder="Email"/>
                    <p className='text-red-700 text-[12px] font-semibold italic'>{FormErrors.email}</p>

                    <input onChange={(e)=> setFormInput({...FormInput, contraseña: e.target.value})} value={FormInput.contraseña} type="password" className="bg-gray-300 w-[210px] h-[27px] mt-5 pl-2 rounded-[5px] outline-none md:w-[240px] md:h-[30px] lg:mt-8 lg:w-[260px] lg:h-[30px]" placeholder="Contraseña"/>
                    ...
                    <button type="submit" className="bg-[#df5454] w-[210px] h-[27px] mt-4 rounded-[8px] text-white hover:bg-[#c74b4b] md:w-[240px] md:h-[27px] lg:mt-8 lg:w-[260px] lg:h-[30px]">Iniciar Sesión</button>

                    <div className="flex justify-center gap-5 pt-7 md:gap-10 md:pt-10">
