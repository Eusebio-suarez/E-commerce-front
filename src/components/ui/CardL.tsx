...
export const CardL = ({ imagen, titulo, descripcion, precio, idLibro } : CardLProps) => {
    return (
        <div className="flex">
            <div className="bg-white h-auto rounded-[13px] py-5 px-5 flex flex-col gap-6 lg:w-3xl lg:h-auto lg:gap-5">
                <img src={imagen} className="w-auto object-cover mx-auto rounded-[12px] h-60 lg:w-auto lg:h-52" alt="Fondo de la Card de libros"/>
                <div className="flex flex-col items-center gap-5 text-center">
                    <h3 className="font-semibold text-[17px] text-gray-800 leading-5 md:px-5">{titulo}</h3>
                    <p className="text-center w-[240px] text-gray-700 text-[14px] lg:text-[16px]">{descripcion}</p>  
                    <div className="flex gap-7 lg:flex-col">
                        <p className="font-semibold text-[18px] text-2xl text-gray-800">${precio}</p> 
