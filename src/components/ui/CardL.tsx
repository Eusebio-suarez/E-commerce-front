...
export const CardL = ({ imagen, titulo, descripcion, precio, boton } : CardLProps) => {
    return (
        <div className="flex">
            <div className="bg-white h-auto rounded-[13px] py-5 gap-5 px-5 flex flex-col">
                ...
                <div className="flex flex-col items-center gap-5 text-center">
                    ...
                    <button className="bg-amber-300 font-semibold w-[175px] flex items-center-safe justify-center h-9 rounded-[11px] text-[16px] hover:bg-amber-400">
